...
class Pagination
{
    ...
    public function get()
    {
        ...
        for ($page = $limits[0]; $page <= $limits[1]; $page++) {
            ...
            if ($page == $this->current_page) {
                $links .= '<li class="active"><a href="#" class="btn btn-primary">' . $page . '</a></li>';
            } else {
                # �?наче генерируем ссылку
    ...
    private function generateHtml($page, $text = null)
    {
        ...
        return
                '<li><a href="' . $currentURI . $this->index . $page . '"  class="btn btn-primary">' . $text . '</a></li>';
    }
